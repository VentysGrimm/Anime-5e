export class LimiterSheet extends ItemSheet {
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            classes: ["anime5e", "sheet", "item", "limiter"],
            template: "systems/anime5e/templates/item/limiter-sheet.html",
            width: 520,
            height: 480,
            tabs: [{
    ...
    _updateObject(event, formData) {
        ...
        if (formData["system.refund.value"]) {
            formData["system.refund.value"] = Number(formData["system.refund.value"]);
        }
